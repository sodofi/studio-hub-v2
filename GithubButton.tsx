...
export default function GithubButton() {
  return (
    <div
      className={clsx(
        "flex items-center rounded-full bg-[#e2dbea]",
        "px-3 py-1 shadow-md hover:bg-white"
      )}
    >
      <svg
      ...
      >
        <path
          d={clsx(
            ...
            "-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089",
      ...
      >
        <div
          className={clsx(
            "px-1 pl-2 text-sm font-medium tracking-tight",
            "text-slate-700"
          )}
        >
          Latest Updates
