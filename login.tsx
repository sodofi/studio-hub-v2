  ...
  return (
    ...
    <div className="md:border md:border-gray-300 bg-white md:shadow-lg shadow-none rounded p-10" >
        ...
        <form className="my-8">
            ...
            <label htmlFor="email" className="label mt-2 ml-3 leading-tighter text-gray-600 text-base cursor-text">Email or phone</label>
                <input id="email" className="w-full rounded px-3 border border-gray-300 pt-5 pb-2 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none input active:outline-none" type="text" autoFocus />
            </div>
            <div className="space-y-9">
                ...
                <div className="text-sm">
                    ...
                    <a className="font-bold text-blue-500" href="#">Learn more</a>
                </div>
                <div className="text-sm flex justify-between items-center">
                    ...
                    <button className="py-2 px-6 rounded text-white btn bg-blue-500 hover:bg-blue-600">Next</button>
                </div>
            </div>
        </form>
    </div>
