      ...
      <div className="flex flex-col items-center sm:px-5 md:flex-row">
        <div className="flex flex-col items-start justify-center w-full h-full pt-6 pr-0 pb-6 pl-0 mb-6 md:mb-0 md:w-1/2">
          <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pr-10 lg:pr-16
            ...
            <a className="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl">Sophia Dew</a>
            <div className="pt-2 pr-0 pb-0 pl-0">
              <p className="text-xl mb-3">Web3 engineer, product designer, and entrepreneur from Stanford University.</p>
              <p className="text-sm font-medium inline">GitHub:</p>
              <a className="inline text-sm hover:text-purple-500 font-medium mt-0 mr-1 mb-0 ml-1 underline" href="https://www.github.com/sophiahdew">sophiahdew</a>
              {/* <p className="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1">· Stanford University ·</p> */}
              <p className="text-white-200 text-sm font-medium inline mt-0 mr-1 mb-0 ml-1">· Last update: March 7, 2023</p>
              ...
              <div className="w-full text-center">
                <div className="flex pt-8 pb-0 lg:pt-4">
                    <div className="flex space-x-2">
                        ...
                        <a 
                          className="bg-purple-400 hover:bg-purple-500 flex items-center leading-none rounded-full text-gray-50 pt-1.5 pr-3 pb-1.5 pl-2 inline-block"
                          href="https://www.linkedin.com/in/sophiadew/"
                          rel="noopener"
                          aria-label="Ariel Cerda on Linkedin"
                          target="_blank"
                        ...
                        <p className="inline text-xs font-medium">Share Page</p>
                      </a>
                    </div>
                </div>
            </div>
        ...
        <div className="flex flex-row-reverse w-full md:w-1/2">
          <div className="block mr-20">
            <img
                src="https://avatars.githubusercontent.com/u/59624772?v=4" className="object-cover rounded-full btn- w-64 h-64"/>
          </div>
        </div>
      </div>
    ...
    <div className="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
      <ProjectPreview 
        props={{
          ...
          description: 'Created a decentralized application (DApp) on Ethereum that functions like Splitwise, a popular app that tracks credit and debit between a group of people. It will be a full-stack development, meaning that both the smart contract and the user client that accesses it will be written. This DApp will be efficient and cost-effective, as no value will be transferred on the blockchain, only the necessary gas. The application will provide a single source of truth for who owes who, and a user interface for non-programmers to use the DApp. This interface will provide useful information for the user and allow them to verify that debts have been recorded on the blockchain. In the end, the cycle of debt will be resolved, and all users will be able to see that no money is owed.'
        }}/>
        <ProjectPreview 
        props={{
          name: 'Polygon Hackathon',
          link: 'https://github.com/sophiahdew/polygon-hackathon',
          description: 'Demonstrated how Polygon, Fauna, and React can be used together to protect sensitive data. The app uses a concept called Allowlisting, which is a process where users submit their first name, last name, and wallet address through a form. The data is then stored in a Fauna database with a randomly generated UUID. A transaction is then submitted to Polygon, which passes in the first name, last name, and wallet address as part of the transaction details, but each property is replaced with the UUID generated for the Fauna database. This allows the users data to remain secure, as the UUID is the only data that is visible in the transaction.'
        }}/>
        <ProjectPreview 
        props={{
          name: 'Team Formation Hub',
          link: 'https://github.com/sophiahdew/team-formation-hub',
          description: 'Built a portal responsible for managing student user groups. It allows users to create, view, and update groups in order to find teammates for a project. The code imports necessary packages and sets up the database connection. It also contains several API endpoints that allow users to perform the aforementioned actions. The endpoints are protected by a middleware function to ensure that the user has the correct permissions to access the group. Finally, the code contains functions that allow users to create, view, and update user groups.'
        }}/>
      {/* <ProjectPreview />
      <ProjectPreview />
      <ProjectPreview />
